...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    void addWorkout(Workout workout){
        ...
        values.put("KEY_EACH_LAP_CALORIES", workout.getId());
        values.put("KEY_FLUC_LAP_CALORIES", workout.getId());
        values.put("KEY_TOTAL_CALORIES", workout.getId());
        values.put("KEY_AVG_CALORIES", workout.getId());
        
        values.put("KEY_EACH_LAP_STEPS", workout.getId());
        values.put("KEY_FLUC_LAP_STEPS", workout.getId());
        values.put("KEY_TOTAL_STEPS", workout.getId());
        values.put("KEY_TOTAL_STEPS", workout.getId());
        values.put("KEY_AVG_STEPS", workout.getId());
